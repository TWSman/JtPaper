...
%The disadvantage is that the jet reconstruction limits the study to a small cone around the jet axis. In addition, the kinematics of produced jets is different. 
...
\begin{figure}[t]
  ...
  %The Gaussian is responsible for the narrow part coming from the hadronisation process, on the other hand, the inverse gamma is for the wide one originating from the showering process.}
...
%The resulting $\jt{}$ distributions are significantly wider than $\jt{}$ distributions from the typical method. The effect seems to be larger than the effect seen in comparing different $R$ values.
